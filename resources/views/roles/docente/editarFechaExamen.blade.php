...
<div class="col-sm-9 col-sm-offset-2">
    <div class="panel panel-default">
        ...
        <form action="{{route('updateFechas', ['idMatEv' => $idMateriaEvaluacion])}}" method="POST" id="formFechaAplicacion">
            @csrf
            ...
            <div class="panel-body">
                <div class="col-sm-12">
                    ...
                    <input type="text" id="gruposDocente" name="gruposDocente" value="{{$gruposDocente}}" hidden>
                    ...
                    <div class="form-group col-sm-12" style="margin: 0;">
                        ...
                        <input type="text" id="fechaId{{$grupo->idFechaAplicacion}}" name="fechaId{{$grupo->idFechaAplicacion}}" value="{{$grupo->idFechaAplicacion}}" class="form-control" hidden>
                        <input type="date" id="aplicacion{{$grupo->id}}" name="aplicacion{{$grupo->id}}" min="{{$fechaAplicacionInicio}}" max="{{$fechaAplicacionFin}}" value="{{$grupo->fechaAplicacion}}" class="form-control" required>
