...
<h3 class="panel-title text-center">Especificaciones Nueva Evaluación Departamental</h3>
</div>  
<form action="{{route('agregarEvaluacion')}}" method="POST" id="formNuevaEvaluacion">
    @csrf
    ...
    <div class="col-sm-12">
       ...
       <label for="periodoRecoleccion">Periodo de recolección de preguntas</label>
        ...
        <div class="form-group col-sm-6" style="margin: 0;">
            ...
            <input type="date" id="inicioRecoleccion" name="inicioRecoleccion" class="form-control" required>
            
        </div>
        <div class="form-group col-sm-6" style="margin: 0;">
            <label for="finRecoleccion">Final</label>
            <input type="date" id="finRecoleccion" name="finRecoleccion" class="form-control" required>
       ...
       <label for="periodoAplicacion">Perido de aplicación</label>
        ...
        <div class="form-group col-sm-6" style="margin: 0;">
            ...
            <input type="date" id="inicioAplicacion" name="inicioAplicacion" class="form-control" required>
            
        </div>
        <div class="form-group col-sm-6" style="margin: 0;">
            <label for="finAplicacion">Final</label>
            <input type="date" id="finAplicacion" name="finAplicacion" class="form-control" required>
